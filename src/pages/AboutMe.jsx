            ...
            <div className='aboutMe-page__info-blocks'>
                ...
                <div className='aboutMe-page__info-block text-block'>
                    <p>
                        Меня зовут Ахмед.
                        <br/>
                        Более трех лет я активно изучаю сферу front-end разработки. За этот период принимал участие в разработке различных сайтов для заказчиков, являюсь автором научной публикации по front-end разработке, прошел ряд профессиональных курсов по данному направлению.
                    </p>
                </div>
            </div>
